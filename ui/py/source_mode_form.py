...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_2.addWidget(self.open_tstlan_button)
        ...
        self.acv_radio = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.aci_radio = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.dci_radio = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.dcv_radio = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.apply_frequency_button = QtWidgets.QPushButton(self.groupBox)
        ...
        self.apply_amplitude_button = QtWidgets.QPushButton(self.groupBox)
        ...
        self.frequency_edit = QEditCopyButton(self.groupBox)
        ...
        self.amplitude_edit = QEditCopyButton(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.source_mode_radio = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.fixed_mode_radio = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.detuning_radio = QtWidgets.QRadioButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.enable_button = QtWidgets.QPushButton(self.groupBox)
        font = QtGui.QFont()
        font.setPointSize(15)
