...
"}")
        ...
        self.other_parameters_page = QtWidgets.QWidget()
        self.other_parameters_page.setObjectName("other_parameters_page")
        self.settings_stackedwidget.addWidget(self.other_parameters_page)
    ...
    def retranslateUi(self, Dialog):
        ...
        item.setText(_translate("Dialog", "Другие параметры измерения"))
